...
CREATE INDEX scheduled_tasks__execution_time_idx on scheduled_tasks(execution_time);
CREATE INDEX scheduled_tasks__last_heartbeat_idx on scheduled_tasks(last_heartbeat);
